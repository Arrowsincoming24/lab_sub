...
public class OrderBookManager {
    ...
    private void recoverActiveOrders() {
        try {
            ...
            List<OrderEntity> activeOrders = orderDao.findActiveOrdersForOrderBookRecovery();
    ...
    public static class OrderBook {
        ...
        public void addOrder(BookOrder order) {
            BookOrder existing = orderIndex.get(order.orderId);
            if (existing != null) {
                // De-duplicate by orderId: remove stale in-memory copy before re-adding.
